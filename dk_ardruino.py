...
class arm_controller:
    ...
    def __init__(self, serialport,LOW_Z=-14, HOVER_Z=-10,DROP_Z=-9, MID_Z=-7, HIGH_Z=-6):
    ...
    def move_toXYZ(self, x, y, z):
        self.move_untildone([x,y,z,0,1,self.DELAY,1])
    ...
    def move_and_pickup(self, x, y):
        ...
        #close
        self.move_untildone([x,y,self.LOW_Z,1,0,self.DELAY*5,1])
        #elevate arm
    ...
    def move_home(self):
        ...
        self.move_untildone([0,0,self.HIGH_Z,1,1,self.DELAY])
    ...
    def move_home_plane(self):
        ...
        self.move_untildone([0,0,self.LOW_Z,1,0,self.DELAY])


    def move_x(self,x):

        self.move_untildone([x,0,self.HIGH_Z,1,0,self.DELAY])



    def move_clearcamera(self):

        self.move_untildone([20,0,self.HIGH_Z,0,1,self.DELAY])
